...
namespace TimetableView
{
    ...
    public partial class App : Application
    {
		...
		private static IUnityContainer BuildUnityContainer()
		{
			...
			currentContainer.RegisterType<IClassroomStorage, ClassroomStorage>(new HierarchicalLifetimeManager());
			...
			currentContainer.RegisterType<ClassroomLogic>(new HierarchicalLifetimeManager());
